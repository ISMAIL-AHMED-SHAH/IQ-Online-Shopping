        ...
        <div className="grid lg:grid-cols-[300px,1fr] gap-4">
          <div className="border border-gray-300 rounded-2xl grid place-items-center p-6 lg:p-0">
            <div className="text-center flex flex-col items-center gap-1">
              ...
              &quot;I absolutely love shopping here! The quality of the products is
                exceptional, and the customer service is top-notch. I always
          ...
          <div className="bg-red-600 bg-[url(/banner-main.png)] bg-cover h-[500px] rounded-2xl grid place-items-center">
